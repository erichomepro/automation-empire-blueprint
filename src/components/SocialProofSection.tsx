...
const SocialProofSection = () => {
  ...
  return (
    <section className="section py-16 bg-dark">
      <div 
        ref={ref}
        className={`max-w-4xl mx-auto bg-gradient-to-br from-muted to-dark p-8 md:p-12 rounded-xl shadow-xl border border-hero/20 transition-all duration-700 ${
          ...
          <div>
            ...
            <div className="flex items-center">
              <div>
                ...
                <p className="text-light/70">Founder of Cerberus Media</p>
              </div>
            </div>
          </div>
        </div>
